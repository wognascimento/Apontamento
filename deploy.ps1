...
$serverUploadPath = "root@192.168.0.49:/var/www/updates/downloads/apontamento/"
...
$updateJson = @{
    ...
    updateUrl = "http://192.168.0.49/downloads/apontamento/$zipFileName"
    changelog = @(
        "Ajustes",
        "Melhorias"
    )
...
scp "$projectPath\version.json" "root@192.168.0.49:/var/www/updates/downloads/apontamento/version.json"
...
Copy-Item -Path "$projectPath\Output\Apontamento.exe" -Destination "RedeTemp:"
